...
// function prompt8() {
  ...
  //   print="The number is medium sized."
  // } else {
  //   print="we got a big one!"
 // }
  // print someNumber to the console in your function so you can see its value
  // console.log(someNumber, print)
  // YOUR CODE HERE
// }
...
// function prompt9() {
  for (let characterName=0; characterName <=4; characterName++){
    console.log(starWars[characterName])
  }
...
// function prompt11() {
 ...
 let middleIndex=  Math.floor (nums.lenth /2)
