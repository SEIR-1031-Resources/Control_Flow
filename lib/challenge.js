...
nums.sort((a,b)=> a-b)
function prompt11() {
  let indexNum = Math.floor(nums.sort.length/2)
  let median = nums[indexNum];

  console.log(median);
}
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
prompt11("Complete prompt 11");
