...
function prompt5() {
  // YOUR CODE HERE
  for (let i = 5; i > -6; i--) console.log(i);
}
...
function prompt8() {
  ...
  if (someNumber < 30) {
    ...
    console.log('We got a medium-sized one!');
  }
}
// prompt8();
...
function prompt11() {
  let median;
  // YOUR CODE HERE
  median = nums.sort().length / 2;

  let middle = Math.floor(median);
