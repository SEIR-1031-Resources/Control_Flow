...
console.log("Completed prompt 1: ")
function prompt1() {
  for (let i = 0; i <= 10; i++) {
    console.log(i);
  }
...
console.log("Completed prompt 2: ")
function prompt2() {
  // YOUR CODE HERE
  for (i=0; i<100; i++) {
    if (i%2 === 0 && i!==0) {
...
console.log("Completed prompt 3: ")
function prompt3() {
  // YOUR CODE HER
  let count = 0;
  const arrayI = []
  ...
  console.log("The numbers are ",arrayI)
}
 ...
 */
console.log("Completed prompt 4: ")
function prompt4() {
  // YOUR CODE HERE
  const arrayI = []
  let count = 0;
 ...
 */
console.log("Completed prompt 5: ")
function prompt5() {
  // YOUR CODE HERE
  let count = 0
  let arrayI = []
 ...
 */
console.log("Completed prompt 6:")
function prompt6() {
  // YOUR CODE HERE
  let count = 0
  let arrayI = []
 ...
 */
console.log("Completed prompt 7: ")
function prompt7() {
  // YOUR CODE HERE
  let count = 0;
  let arrayI = []
...
console.log("Completed prompt 8: ")
 ...
 *  2. R2D2
 */
console.log("Completed prompt 9:")
 ...
 */
console.log("Completed prompt 10: ")
function prompt10() {
  const myArray = [];
  // YOUR CODE HERE
  for (i=0; i<=100; i++) {
...
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
 //console.log("An array with even numbers from 0 to 100: ",prompt10());
 ...
 */
console.log("Completed prompt 11: ")
let nums = [
  14,
  11,
  16,
...
function prompt11() {
  ...
  let position = 0;
  // YOUR CODE HERE
  position = Math.floor(nums.length / 2)
  median = nums[position]
  console.log("The median in nums array: ",median)
}
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
 //prompt11();
 ...
 */
console.log("Completed prompt 12: ")
function prompt12() {
  // YOUR CODE HERE
  let arrayI = []
  let arrayJ = []
...
console.log("Completed prompt 13: ")
const print = []
function prompt13() {
  // YOUR CODE HERE
  for (i=0; i < nestedArrays.length; i++) {
    for (j=0; j < nestedArrays[i].length; j++) {
      print.push(nestedArrays[i][j])
    }
  }
  console.log("Print all the values inside the nested arrays: ",print)
}
